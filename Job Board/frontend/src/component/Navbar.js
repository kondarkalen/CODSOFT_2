                        ...
                        >

                            {
                                userInfo && userInfo.role === 1 ?
                                    ...
                                    <MenuItem onClick={handleCloseUserMenu}>
                                        <Typography textAlign="center"><Link style={{ textDecoration: "none", color: palette.secondary.main }} to="/user/dashboard">{userInfo ? "User Dashboard" : ""}</Link></Typography>
                                    </MenuItem>
                            }
                            {
                                !userInfo ?
