                        ...
                        >
                            ...
                            <Box sx={{ flex: 1, p: 2 }}>
                                <Card sx={{ p: 2, bgcolor: palette.primary.white }}>
                                    <Button onClick={applyForAJob} sx={{ fontSize: "13px" }} variant='contained'>{userInfo.role===1 ? "Admin":"Apply for this Job"}</Button>
                                </Card>
                            </Box> :
                            <Box sx={{ flex: 1, p: 2 }}>
                                <Card sx={{ p: 2, bgcolor: palette.primary.white }}>
                                    <Button sx={{ fontSize: "13px" }} variant='contained'>Login to apply</Button>
                                </Card>
                            </Box>
                            }
