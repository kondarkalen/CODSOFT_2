...
import logoAdmin from '../../images/hr-project.png'
import logoUser from '../../images/hr-logo.jpg'
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between", flexDirection: "column", height: "100%" }}>
                    <Box>
                        <Box sx={{ pt: 3, pb: 5, display: "flex", justifyContent: "center" }}>
                            {
                                collapsed ?
                                    <Avatar alt="logo dashboard" src={userInfo.role===1 ? logoAdmin : logoUser} /> :
                                    <Box sx={{ display: "flex", justifyContent: "center" }}>
                                        <img style={{ width: "100px", heigth: "100px", textAlign: "center", transition: "all ease-out .5s" }} src={userInfo.role===1 ? logoAdmin : logoUser} alt="logo dashboard" />
                                    </Box>
                            }
                        </Box>
                        ...
                        >
                            {
                                userInfo && userInfo.role === 1 ?
                                    <>
                                        <MenuItem component={<Link to="/" />} icon={<CategoryIcon />}> Home </MenuItem>
